...
public class SymregEvaluatorDerivativeSign_1_xy extends AbstractEvaluator implements IConfigure
{
	...
	public void configure(Configuration settings)
	{
		...
		String[] z = settings.getStringArray("yvalues");
		...
		for(int i = 0; i < numberElements; i++)
		{
			...
			yvalues[i] = Double.parseDouble(z[i]);
		}
	}
	...
	protected void evaluate(IIndividual ind) 
	{
		...
		double [] xvaluesinter = new double[xvalues.length-1];
